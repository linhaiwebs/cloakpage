...
!function(i, D) {
    ...
    var n = i.layui && layui.define
      ...
      , k = function(e) {
        ...
        n[0] && n.attr(o) ? (t = s.getThis(n.attr(o))) ? t.reload(e) : void 0 : (e.id = "id"in e ? e.id : n.attr("id") || a.index,
        e.index = a.index,
    ...
    k.prototype.init = function() {
        ...
        d.elem[0] && ("array" !== layui.type(d.theme) && (d.theme = [d.theme]),
        d.fullPanel && ("datetime" !== d.type || d.range) && delete d.fullPanel,
        r.rangeStr = d.range ? "string" == typeof d.range ? d.range : "-" : "",
        r.rangeLinked = !(!d.range || !d.rangeLinked || "date" !== d.type && "datetime" !== d.type),
        r.autoCalendarModel = function() {
            var e = r.rangeLinked;
            return r.rangeLinked = d.range && ("date" === d.type || "datetime" === d.type) && (!r.startDate || !r.endDate || r.startDate && r.endDate && r.startDate.year === r.endDate.year && r.startDate.month === r.endDate.month),
            lay(r.elem)[r.rangeLinked ? "addClass" : "removeClass"]("layui-laydate-linkage"),
            r.rangeLinked != e
        }
        ,
        r.autoCalendarModel.auto = r.rangeLinked && "auto" === d.rangeLinked,
        "array" === layui.type(d.range) && (r.rangeElem = [lay(d.range[0]), lay(d.range[1])]),
        t[d.type] || (i.console && console.error && console.error("laydate type error:'" + d.type + "' is not supported"),
        d.type = "date"),
        d.format === t.date && (d.format = t[d.type] || t.date),
        r.format = s.formatArr(d.format),
        d.weekStart && !/^[0-6]$/.test(d.weekStart) && (t = r.lang(),
        d.weekStart = t.weeks.indexOf(d.weekStart),
        -1 === d.weekStart) && (d.weekStart = 0),
        r.EXP_IF = "",
        r.EXP_SPLIT = "",
        ...
        r.EXP_IF = new RegExp("^" + (d.range ? r.EXP_IF + "\\s\\" + r.rangeStr + "\\s" + r.EXP_IF : r.EXP_IF) + "$"),
        r.EXP_SPLIT = new RegExp("^" + r.EXP_SPLIT + "$",""),
        r.isInput(d.elem[0]) || "focus" === d.trigger && (d.trigger = "click"),
        d.elem.attr("lay-key", r.index),
        d.eventElem.attr("lay-key", r.index),
        d.elem.attr(o, d.id),
        d.mark = lay.extend({}, d.calendar && "cn" === d.lang ? {
            "0-1-1": "\u5143\u65e6",
            "0-2-14": "\u60c5\u4eba",
            "0-3-8": "\u5987\u5973",
            "0-3-12": "\u690d\u6811",
        ...
        lay.each(["min", "max"], function(e, t) {
            ...
            else if ("string" == typeof d[t])
                a = (d[t].match(/\d+-\d+-\d+/) || [""])[0].split("-"),
                n = (d[t].match(/\d+:\d+:\d+/) || [""])[0].split(":");
            else if ("object" == typeof d[t])
                return d[t];
            d[t] = {
        ...
        r.elemID = "layui-laydate" + d.elem.attr("lay-key"),
        (d.show || e) && r.render(),
        e || r.events(),
        d.value) && d.isInitValue && ("date" === layui.type(d.value) ? r.setValue(r.parse(0, r.systemDate(d.value))) : r.setValue(d.value))
    }
    ,
    k.prototype.render = function() {
        var a, n, i, l, r = this, d = r.config, o = r.lang(), s = "static" === d.position, y = r.elem = lay.elem("div", {
            id: r.elemID,
            "class": ["layui-laydate", d.range ? " layui-laydate-range" : "", r.rangeLinked ? " layui-laydate-linkage" : "", s ? " " + v : "", d.fullPanel ? " laydate-theme-fullpanel" : "", (a = "",
            lay.each(d.theme, function(e, t) {
        ...
        }), p = (d.zIndex && (y.style.zIndex = d.zIndex),
        lay.each(new Array(2), function(e) {
            ...
            lay.each(new Array(6), function(a) {
                ...
                lay.each(new Array(7), function(e) {
                    var t;
                    0 === a && ((t = lay.elem("th")).innerHTML = o.weeks[(e + d.weekStart) % 7],
                    r.appendChild(t)),
                    n.insertCell(e)
                })
            }),
        ...
        lay(e).html((p = [],
        n = [],
        "datetime" === d.type && p.push('<span lay-type="datetime" class="' + I + '">' + o.timeTips + "</span>"),
        (d.range || "datetime" !== d.type || d.fullPanel) && p.push('<span class="' + x + '" title="' + o.preview + '"></span>'),
        lay.each(d.btns, function(e, t) {
            var a = o.tools[t] || "btn";
            d.range && "now" === t || (s && "clear" === t && (a = "cn" === d.lang ? "\u91cd\u7f6e" : "Reset"),
            n.push('<span lay-type="' + t + '" class="laydate-btns-' + t + '">' + a + "</span>"))
        }),
        p.push('<div class="laydate-footer-btns">' + n.join("") + "</div>"),
        p.join(""))),
        d.shortcuts && (y.appendChild(t),
        lay(t).html((i = [],
        lay.each(d.shortcuts, function(e, t) {
        ...
        i.join(""))).find("li").on("click", function(e) {
            ...
            lay(r.footer).find("." + I).removeClass(M));
        ...
        d.showBottom && y.appendChild(e),
        lay.elem("style")), f = [], g = !0, t = (lay.each(d.theme, function(e, t) {
            g && /^#/.test(t) ? (g = !(l = !0),
        ...
        d.shortcuts && d.range && f.push("#{{id}}.layui-laydate-range{width: 628px;}".replace(/{{id}}/g, r.elemID)),
        f.length && (f = f.join(""),
        ...
        T.thisId = d.id,
        s ? d.elem.append(y) : (D.body.appendChild(y),
        r.position()),
        d.shade ? '<div class="' + w + '" style="z-index:' + (parseInt(layui.getStyle(y, "z-index")) - 1) + "; background-color: " + (d.shade[1] || "#000") + "; opacity: " + (d.shade[0] || d.shade) + '"></div>' : "");
    ...
    k.prototype.checkDate = function(e) {
        var t, d, a, n, i, o = this, s = (new Date,
        o.config), l = o.lang(), r = s.dateTime = s.dateTime || o.systemDate(), y = s.elem[0], m = (o.isInput(y),
        function() {
            if (o.rangeElem) {
            ...
            lay.each(o.format, function(e, t) {
                ...
                d = !0),
                n.date = a) : /HH|H/.test(t) ? (a < 0 && (d = !(a = 0)),
                23 < a && (a = 23,
                d = !0),
                n.hours = a,
                s.range && (o[r[l]].hours = a)) : /mm|m/.test(t) ? (a < 0 && (d = !(a = 0)),
                59 < a && (a = 59,
                d = !0),
                n.minutes = a,
                s.range && (o[r[l]].minutes = a)) : /ss|s/.test(t) && (a < 0 && (d = !(a = 0)),
                59 < a && (a = 59,
                d = !0),
                n.seconds = a,
                s.range) && (o[r[l]].seconds = a)
            }),
            u(n)
        };
        return "limit" === e ? s.range ? (u(o.rangeLinked ? o.startDate : r),
        o.endDate && u(o.endDate)) : u(r) : ("string" == typeof (m = m || s.value) && (m = m.replace(/\s+/g, " ").replace(/^\s|\s$/g, "")),
        (a = function() {
            var e, t, a;
            s.range && (o.endDate = o.endDate || lay.extend({}, s.dateTime, (e = {},
            t = s.dateTime,
            a = o.getAsYM(t.year, t.month),
        ...
        "string" == typeof m && m ? o.EXP_IF.test(m) ? s.range ? (m = m.split(" " + o.rangeStr + " "),
        lay.each([s.dateTime, o.endDate], function(e, t) {
            c(t, m[e], e)
        })) : c(r, m) : (o.hint(l.formatError[0] + (s.range ? s.format + " " + o.rangeStr + " " + s.format : s.format) + l.formatError[1]),
        d = !0) : m && "date" === layui.type(m) ? s.dateTime = o.systemDate(m) : (s.dateTime = o.systemDate(),
        delete o.startTime,
        delete o.endDate,
        a(),
        delete o.endTime),
        o.rangeElem && (a = [o.rangeElem[0].val(), o.rangeElem[1].val()],
        n = [s.dateTime, o.endDate],
        lay.each(a, function(e, t) {
            o.EXP_IF_ONE.test(t) && c(n[e], t, e)
        })),
        u(r),
        s.range && u(o.endDate),
        d && m && o.setValue(!s.range || o.endDate ? o.parse() : ""),
        o.getDateTime(r) > o.getDateTime(s.max) ? (r = s.dateTime = lay.extend({}, s.max),
        i = !0) : o.getDateTime(r) < o.getDateTime(s.min) && (r = s.dateTime = lay.extend({}, s.min),
        i = !0),
        s.range && ((o.getDateTime(o.endDate) < o.getDateTime(s.min) || o.getDateTime(o.endDate) > o.getDateTime(s.max)) && (o.endDate = lay.extend({}, s.max),
        i = !0),
        o.startTime = {
        ...
        o.endDate.date = 1),
        i && m && (o.setValue(o.parse()),
        o.hint("value " + l.invalidDate + l.formatError[1])),
        o.startDate = o.startDate || m && lay.extend({}, s.dateTime),
        o.autoCalendarModel.auto && o.autoCalendarModel(),
        o.endState = !s.range || !o.rangeLinked || !(!o.startDate || !o.endDate),
        e && e()),
        o
    }
    ,
    ...
    k.prototype.holidays = function(r, d) {
        var e = this.config
          , o = ["", "work"];
        return "array" === layui.type(e.holidays) && lay.each(e.holidays, function(l, e) {
    ...
    k.prototype.calendar = function(e, i, t) {
        i = i ? 1 : 0;
        var l, r, d, o = this, a = o.config, s = e || o.thisDateTime(i), n = new Date, y = o.lang(), m = "date" !== a.type && "datetime" !== a.type, u = lay(o.table[i]).find("td"), c = lay(o.elemHeader[i][2]).find("span");
        ...
        lay.each(u, function(e, t) {
            ...
            n = o.getAsYM(s.year, s.month, "sub")) : l <= e && e < d + l ? (a = e - l,
            o.rangeLinked || a + 1 === s.date && t.addClass(C)) : (a = e - d - l,
            t.addClass("laydate-day-next"),
            n = o.getAsYM(s.year, s.month)),
            n[1]++,
            n[2] = a + 1,
        ...
        m && (a.range ? !e && "init" === t || (o.listYM = [[(o.startDate || a.dateTime).year, (o.startDate || a.dateTime).month + 1], [o.endDate.year, o.endDate.month + 1]],
        o.list(a.type, 0).list(a.type, 1),
        "time" === a.type ? o.setBtnStatus("\u65f6\u95f4", lay.extend({}, o.systemDate(), o.startTime), lay.extend({}, o.systemDate(), o.endTime)) : o.setBtnStatus(!0)) : (o.listYM = [[s.year, s.month + 1]],
        o.list(a.type, 0))),
        a.range && "init" === t && (o.rangeLinked ? (n = o.getAsYM(s.year, s.month, i ? "sub" : null),
        o.calendar(lay.extend({}, s, {
            year: n[0],
            month: n[1]
    ...
    k.prototype.list = function(n, i) {
        var l, r, e, a, d, o, t, s = this, y = s.config, m = s.rangeLinked ? y.dateTime : [y.dateTime, s.endDate][i], u = s.lang(), c = y.range && "date" !== y.type && "datetime" !== y.type, h = lay.elem("ul", {
            "class": b + " " + {
        ...
        lay(h).find("li").on("click", function() {
            ...
            "year" === y.type || "month" === y.type ? (lay(h).find("." + C).removeClass(C),
            lay(this).addClass(C),
            ...
            lay(s.footer).find("." + I).removeClass(M))
        })) : (f = lay.elem("span", {
            "class": E
        }),
        o = function() {
        ...
        (D = lay(h).find("ol")).each(function(t) {
            ...
            lay(a).find("li").on("click", function() {
                ...
                lay(this).hasClass(M) || (y.range ? s[k][w[t]] = e : m[w[t]] = e,
                lay(a).find("." + C).removeClass(C),
                lay(this).addClass(C),
                r(),
                o(),
                (s.endDate || "time" === y.type || "datetime" === y.type && y.fullPanel) && s.done(null, "change"),
                s.setBtnStatus())
            })
        }),
    ...
    k.prototype.setBtnStatus = function(e, t, a) {
        ...
        n.limit({
            ...
            time: d,
            rangeType: 1
        }) ? r.addClass(M) : r[i ? "addClass" : "removeClass"](M),
    ...
    k.prototype.choose = function(e, a) {
        ...
        n.endState && !n.limit({
            ...
            disabledType: "date"
        }) && (((r = n.endState && n.autoCalendarModel.auto ? n.autoCalendarModel() : r) || n.rangeLinked && n.endState) && n.newDate(n.startDate) > n.newDate(n.endDate) && (n.startDate.year === n.endDate.year && n.startDate.month === n.endDate.month && n.startDate.date === n.endDate.date && (d = n.startTime,
        n.startTime = n.endTime,
        n.endTime = d),
        d = n.startDate,
        n.startDate = lay.extend({}, n.endDate, n.startTime),
        i.dateTime = lay.extend({}, n.startDate),
        n.endDate = lay.extend({}, d, n.endTime)),
        r) && (i.dateTime = lay.extend({}, n.startDate)),
        n.rangeLinked ? (e = lay.extend({}, l),
        !t || a || r || (d = n.getAsYM(l.year, l.month, "sub"),
    ...
    k.prototype.tool = function(t, e) {
        var a = this
          ...
          , d = {
            datetime: function() {
                lay(t).hasClass(M) || (a.list("time", 0),
    ...
    k.prototype.change = function(n) {
        ...
        return {
            prevYear: function() {
                ...
                i.autoCalendarModel.auto ? i.choose(lay(o).find("td.layui-this"), n) : i.done(null, "change")))
            },
            prevMonth: function() {
...
!function(p, h) {
    ...
    var m, g, e, n = p.layui && layui.define, d = {
        ...
        link: function(e, i, t) {
            ...
            "function" == typeof i) && !function c(e) {
                ...
                return 100 < ++l ? p.console && console.error(o + ".css: Invalid") : void (1989 === parseInt(d.getStyle(t, "width")) ? (e === r && t.removeAttribute("lay-status"),
        ...
        path: d.getPath,
        config: function(e, t) {
            return v.cache = d.config = m.extend({}, d.config, e = e || {}),
        ...
        msg: function(e, t, i) {
            ...
            v.open(m.extend({
                ...
                anim: o
            } : (-1 !== (t = t || {}).icon && (t.icon !== h || d.config.skin) || (t.skin = a + " " + (t.skin || "layui-layer-hui")),
            t)))
        },
        load: function(e, t) {
            return v.open(m.extend({
    ...
    ,
    t.pt.creat = function() {
        var e, t, i, n, a = this, o = a.config, s = a.index, r = "object" == typeof (f = o.content), l = m("body"), c = function(e) {
            var t;
        ...
        if (o.id && m("." + u[0]).find("#" + o.id)[0])
            ...
            switch (o.removeFocus && document.activeElement.blur(),
            "string" == typeof o.area && (o.area = "auto" === o.area ? ["", ""] : [o.area, ""]),
            6 == v.ie && (o.fixed = !1),
            o.type) {
            case 0:
                o.btn = "btn"in o ? o.btn : d.btn[0],
                v.closeAll("dialog");
                break;
            case 2:
            ...
            a.vessel(r, function(e, t, i) {
                l.append(e[0]),
                r ? 2 == o.type || 4 == o.type ? m("body").append(e[1]) : f.parents("." + u[0])[0] || (f.data("display", f.css("display")).show().addClass("layui-layer-wrap").wrap(e[1]),
                m("#" + u[0] + s).find("." + u[5]).before(t)) : l.append(e[1]),
            ...
            parseInt(d.getStyle(document.getElementById(u.MOVE), "z-index")) || (a.layero.css("visibility", "hidden"),
            v.ready(function() {
                a.offset(),
    ...
    t.pt.move = function() {
        ...
        d.docEvent || (e.on("mousemove", function(e) {
            var t, i, n, a, o, s, r;
            d.eventMoveElem && (t = (a = d.eventMoveElem.data(l[0]) || {}).layero,
            o = a.config,
            ...
            d.eventResizeElem && (o = (a = d.eventResizeElem.data(l[1]) || {}).config,
            s = e.clientX - a.offset[0],
            r = e.clientY - a.offset[1],
            e.preventDefault(),
            v.style(a.index, {
            ...
            var t, i;
            d.eventMoveElem && (i = (t = d.eventMoveElem.data(l[0]) || {}).config,
            d.eventMoveElem.removeData(l[0]),
            delete d.eventMoveElem,
            d.moveElem.hide(),
            i.moveEnd) && i.moveEnd(t.layero),
            d.eventResizeElem && (d.eventResizeElem.removeData(l[1]),
    ...
    t.pt.callback = function() {
        ...
        i.find(".layui-layer-max").on("click", function() {
            m(this).hasClass("layui-layer-maxmin") ? (v.restore(t.index),
            n.restore && n.restore(i, t.index, t)) : (v.full(t.index, n),
            setTimeout(function() {
    ...
    v.min = function(e, t) {
        ...
        d.minStackArr.shift()),
        parseFloat(o) + 180 > g.width() && (o = g.width() - 180 - (d.minStackArr.edgeIndex = d.minStackArr.edgeIndex || 0,
    ...
    v.restore = function(e) {
        ...
        r !== h && (n.removeData(l),
        (o === d.type[2] ? n.children("iframe") : n).css({
            height: r
        })),
        i.show()
    }
    ...
    v.close = function(o, s) {
        var r, e, t, l = (i = m("." + u[0]).children("#" + o).closest("." + u[0]))[0] ? (o = i.attr("times"),
        i) : m("#" + u[0] + o), c = l.attr("type"), i = l.data("config") || {}, f = i.id && i.hideOnClose;
        l[0] && (r = {
        ...
        e = function() {
            ...
            if (f)
                return l.removeClass("layer-anim " + r),
                l.hide();
            ...
            delete d.end[o],
            "function" == typeof s && s(),
            d.events.resize[o] && (g.off("resize", d.events.resize[o]),
        ...
        6 == v.ie && d.reselect(),
        d.restScrollbar(o),
        "string" == typeof l.attr("minLeft") && (d.minStackIndex--,
        d.minStackArr.push(l.attr("minLeft"))),
...
layui.define(["jquery", "laytpl", "lay", "util"], function(e) {
    "use strict";
    var n, i, t, c = layui.$, m = layui.laytpl, p = layui.util, l = layui.hint(), o = layui.device().mobile ? "touchstart" : "mousedown", r = "dropdown", y = "layui_" + r + "_index", f = {
        config: {
            customName: {
                id: "id",
                title: "title",
    ...
    }, g = "layui-dropdown", a = "layui-menu-item-up", d = "layui-menu-item-down", v = "layui-menu-body-title", s = "layui-menu-item-group", w = "layui-menu-item-parent", u = "layui-menu-item-checked", V = "layui-menu-item-checked2", C = "layui-menu-body-panel", x = "layui-menu-body-panel-left", b = "layui-dropdown-shade", k = "." + s + ">." + v, T = function(e) {
        var i = this;
        i.index = ++f.index,
    ...
    T.prototype.init = function(e, i) {
        ...
        !e && a[0] && a.data(y) ? (t = h.getThis(a.data(y))) ? t.reload(l, i) : void 0 : (l.elem = c(l.elem),
        l.id = "id"in l ? l.id : a.attr("id") || n.index,
        l.customName = c.extend({}, f.config.customName, l.customName),
    ...
    T.prototype.render = function(e, i) {
        var a = this
          ...
          , u = function(r, e) {
            return layui.each(e, function(e, i) {
                ...
                n ? '<div class="' + v + '">' + t + ("parent" === o ? '<i class="layui-icon layui-icon-right"></i>' : "group" === o && d.isAllowSpread ? '<i class="layui-icon layui-icon-' + (l ? "up" : "down") + '"></i>' : "") + "</div>" : '<div class="' + v + '">' + t + "</div>"), "</li>"].join(""))).data("item", i),
        ...
        !(e = "contextmenu" !== d.trigger && !lay.isTopElem(d.elem[0]) ? e : !0) && d.elem.data(y + "_opened") || (a.elemView = c("." + g + '[lay-id="' + d.id + '"]'),
        ...
        e = d.shade ? '<div class="' + b + '" style="z-index:' + (a.elemView.css("z-index") - 1) + "; background-color: " + (d.shade[1] || "#000") + "; opacity: " + (d.shade[0] || d.shade) + '"></div>' : "",
        a.elemView.before(e),
        ...
        a.position(),
        (h.prevElem = a.elemView).data("prevElem", d.elem),
    ...
    i.on(o, function(e) {
        var i, t;
        f.thisId && (i = h.getThis(f.thisId)) && (t = i.config,
    ...
    i.on("click", t, function(e) {
        ...
        a.title = a.title || c.trim(i.children("." + v).text()),
...
layui.define(["lay", "layer", "util"], function(e) {
    ...
    t.prototype.render = function(e, t) {
          ...
          , n = {
            input: function(e) {
                ...
                function(e, t) {
                    ...
                    }).increment[r <= a && !o ? "addClass" : "removeClass"](F),
                    n.decrement[a <= l && !o ? "addClass" : "removeClass"](F))
                }
                );
                a.find("input[lay-affix],textarea[lay-affix]").each(function() {
                    var r = T(this)
                      ...
                      , d = function(e, t) {
                        (e = T(e))[0] && e[T.trim(t) ? "removeClass" : "addClass"](_)
                    }
                      , n = function(i) {
                        i = T.extend({}, f[s] || {
                            value: s
                        ...
                        e.on("click", function() {
                            ...
                            T(this).hasClass(F) || ("function" == typeof i.click && i.click.call(this, r, i),
            ...
            select: function(e) {
                var m, u = "\u8bf7\u9009\u62e9", g = "layui-form-select", b = "layui-select-title", x = "layui-select-none", k = "layui-select-create-option", C = "", e = e || a.find("select"), w = function(e, t) {
                    T(e.target).parent().hasClass(b) && !t || ((e = T("." + g)).removeClass(g + "ed " + g + "up"),
                    e.hasClass("layui-select-creatable") && e.children("dl").children("." + k).remove(),
                    m && C && m.val(C)),
                    m = null
                }, d = function(a, e, t, c) {
                    var s, u, n, i, o, d, l, r = T(this), f = a.find("." + b), h = f.find("input"), y = a.find("dl"), v = (y.children("dd"),
                    y.children("dt")), p = this.selectedIndex;
                    e || (u = r.attr("lay-search"),
                    n = !(!lay.ie || "10" !== lay.ie && "11" !== lay.ie || !h.attr("placeholder")),
                    i = function() {
                    ...
                    ,
                    d = function() {
                        var e, t, i = y.children("dd." + $);
                        i[0] && (e = i.position().top,
                        t = y.height(),
                        i = i.height(),
                        t < e && y.scrollTop(e + y.scrollTop() - t + i - 5),
                        e < 0) && y.scrollTop(e + y.scrollTop() - 5)
                    }
                    ,
                    f.on("click", function(e) {
                        (a.hasClass(g + "ed") ? o : (w(e, !0),
                        i))(),
                        y.find("." + x).remove()
                    }),
                    ...
                    h.on("keyup", function(e) {
                        ...
                        function(a, n) {
                            ...
                            var e = function() {
                              ...
                              , i = e[a]("dd:not(." + _ + ")");
                            return t[0] ? (s = e[a](),
                            i[0] && !i.hasClass(F) || !s[0] ? (i.addClass($).siblings().removeClass($),
                            void d()) : r(a, s)) : s = null
                        }
                        );
                        38 === e && r("prev"),
                    ...
                    l = function(n, e, l) {
                        ...
                        "keyup" === l && layui.each(v, function() {
                            ...
                            e[(t = c ? t.not("." + k) : t).length == t.filter("." + _).length ? "addClass" : "removeClass"](_)
                        }),
                        r === t.length);
                        return e(t, s),
                        t
                    ...
                    t && h.on("input propertychange", layui.debounce(function(e) {
                        ...
                        return 9 !== t && 13 !== t && 37 !== t && 38 !== t && 39 !== t && 40 !== t && (n && e.target.__ieph ? e.target.__ieph = !1 : (l(a, function(e, t) {
                            var i;
                            c ? t ? y.children("." + k).remove() : (t = T("<div>" + a + "</div>").text(),
                            (i = y.children("." + k))[0] ? (i.attr("lay-value", a),
                            i.text(t)) : y.append('<dd class="' + k + '" lay-value="' + a + '">' + t + "</dd>")) : e ? y.find("." + x)[0] || y.append('<p class="' + x + '">\u65e0\u5339\u914d\u9879</p>') : y.find("." + x).remove()
                        }, "keyup"),
                        "" === a && (r.val(""),
                        y.find("." + $).removeClass($),
                        (r[0].options[0] || {}).value || y.children("dd:eq(0)").addClass($),
                        y.find("." + x).remove(),
                        c) && y.children("." + k).remove(),
                        void d()))
                    ...
                    y.on("click", "dd", function() {
                        var e = T(this)
                          , t = e.attr("lay-value")
                          , i = r.attr("lay-filter");
                        return e.hasClass(F) || (e.hasClass("layui-select-tips") ? h.val("") : (h.val(e.text()),
                        e.addClass($)),
                        c && e.hasClass(k) && (e.removeClass(k),
                        r.append('<option value="' + t + '">' + t + "</option>")),
                        e.siblings().removeClass($),
                        r.val(t).removeClass("layui-form-danger"),
                        layui.event.call(this, N, "select(" + i + ")", {
                            elem: r[0],
                            value: t,
                            othis: a
                        }),
                ...
                e.each(function(e, t) {
                    ...
                    0 === s.length && s.push('<dd lay-value="" class="' + F + '">\u6ca1\u6709\u9009\u9879</dd>'),
                    s.join("") + "</dl>"), "</div>"].join(""));
                    a[0] && a.remove(),
                    i.after(r),
                    d.call(this, r, n, o, c)
            ...
            radio: function(e) {
                ...
                e.each(function(e, t) {
                    ...
                    r = r.join(" "),
                    T(['<div class="layui-unselect ' + o, t.checked ? " " + o + "ed" : "", (n ? " layui-radio-disabled " + F : "") + '"', l ? ' lay-skin="' + l + '"' : "", ">", '<i class="layui-anim layui-icon ' + c[t.checked ? 0 : 1] + '"></i>', "<div " + r + ">" + a + "</div>", "</div>"].join("")));
                    i.after(s),
                    function(a) {
                        var n = T(this)
                        ...
                        a.on("click", function() {
                            ...
                            layui.event.call(n[0], N, "radio(" + i + ")", {
                                elem: n[0],
                                value: n[0].value,
                                othis: a
                            }))
        ...
        return "object" === layui.type(e) ? T(e).is(u) ? (a = T(e),
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function(n) {
    ...
    i.prototype.setGroupWidth = function(i) {
        var e, l = this;
        l.config.cols.length <= 1 || ((e = l.layHeader.find((i ? "th[data-key=" + i.data("parentkey") + "]>" : "") + "." + I)).css("width", 0),
    ...
    i.prototype.events = function() {
        ...
        e.on("mousemove", function(e) {
            ...
            f(this);
            w.eventMoveElem || (d.allowResize = !1,
            o.css("cursor", ""))
        }).on("mousedown", function(e) {
            var t, a = f(this);
...
layui.define(["table"], function(e) {
    ...
    j.sort = function(e) {
        ...
        ,
        t.autoSort) && ((n = t.initSort).type ? l(a, n.field, "desc" === n.type) : l(a, B.config.indexName, null),
        B.cache[e] = a,
        d.initData(a),
        j.renderData(e))
    }
...
layui.define("jquery", function(o) {
    ...
    e.prototype.load = function(o) {
        var i, n, r, e, c, m, l, a, s, u, f, p, t, d, y = this, h = 0, g = v((o = o || {}).elem);
        if (g[0])
            return c = v(o.scrollElem || document),
            m = "mb"in o ? o.mb : 50,
            ...
            t = function(o, e) {
                ...
                i = null,
                r && r(),
                s && (o = u ? c.prop("scrollHeight") : document.documentElement.scrollHeight,
                1 === h ? c.scrollTop(o) : 1 < h && c.scrollTop(t + (o - l)))
            }
            ,
            (d = function() {
                i = !0,
    ...
    e.prototype.lazyimg = function(o) {
        var e, m = this, a = 0, s = v((o = o || {}).scrollElem || document), u = o.elem || "img", n = "top" === (o.direction || "bottom"), f = o.scrollElem && o.scrollElem !== document, p = function(e, o) {
            var l, t = s.scrollTop(), o = t + o, i = f ? e.offset().top - s.offset().top + t : e.offset().top;
            (n ? i + e.height() : i) >= t && i <= o && e.attr("lay-src") && (l = e.attr("lay-src"),
